  ...
  return (
    <div className="home-container">
      <div className="home-mode-tabs">
        <button className={`home-mode-tab${mode === 'dynasty' ? ' active' : ''}`} onClick={() => switchMode('dynasty')}>
          Dynasty League
        </button>
        <button className={`home-mode-tab${mode === 'auction' ? ' active' : ''}`} onClick={() => switchMode('auction')}>
          Auction Draft
        </button>
      </div>
