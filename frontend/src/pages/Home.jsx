    ...
    <div className="home-container">
      ...
      <div className="home-tool-cards">
        <Link to="/draft-assistant" className="home-tool-card">
          ...
          <div className="home-tool-desc">Live draft board for Sleeper and Yahoo — snake and auction. Real-time picks, tier breaks, and VOR.</div>
          <div className="home-tool-cta">Open →</div>
        </Link>
        <Link to="/redraft-trades" className="home-tool-card">
          <div className="home-tool-icon">⚖️</div>
          <div className="home-tool-name">Trade Evaluator</div>
          <div className="home-tool-desc">Build any trade and get instant value analysis in redraft or dynasty mode.</div>
          <div className="home-tool-cta">Open →</div>
        </Link>
      </div>
        ...
        <div className="feature-grid">
          <div className="feature-card">
            ...
            <p>
              ...
              Championship Window, Ascending, Full Rebuild, and more.
            </p>
          </div>
          <div className="feature-card">
          ...
          <div className="feature-card">
            ...
            <p>
              ...
              Instant asset value, lineup delta, age shift, and contention window fit.
            </p>
          </div>
          <div className="feature-card">
            <div className="feature-icon">🔗</div>
            ...
            <p>
              ...
              tagged as drafted, traded, or claimed.
            </p>
          </div>
        </div>
      </div>
